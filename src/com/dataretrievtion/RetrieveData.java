...
public class RetrieveData {
    ...
    private static final int TWEETS_PER_QUERY		= 50;
...
//    private static final String SEARCH_TERM= "until:2015-08-23 and love";
    ...
    public static ArrayList<Tweet> getTweetObjectList(ArrayList<Brand> brands) {
        ...
        ArrayList<Tweet> tweetObjectList = new ArrayList<>();

        for(Brand brand : brands) {

            String SEARCH_TERM = brand.getSearchTerm();
            ...
            try {
                ...
                for (int queryNumber = 0; queryNumber < MAX_QUERIES; queryNumber++) {
                    ...
                    for (Status s : r.getTweets())                // Loop through all the tweets...
                    {
                        ...
                        tweetObject.setBrandName(brand.getBrandName());
